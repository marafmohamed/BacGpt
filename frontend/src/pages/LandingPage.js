   ...
   <div className="bg-[#FFF3E4] rounded-b-[60px] lg:rounded-b-[120px]">
    ...
    <div id="BacGPT">
      ...
      <div className="flex flex-col items-center justify-center mt-8">
        ...
        />
        <button onClick={handleBacGPTClick} className="px-12 py-2 text-[#000000] mt-2 lg:mb-6 bg-transparent border border-black text-white rounded-full font-Poppins">Ahdar m3a GptBac</button>
      </div>
      <div className="flex flex-col mt-8 items-center justify-center">
        ...
        />
         <button onClick={handleDawaratClick} className="px-12 py-2 text-[#000000] mt-2 mb-4 lg:mb-0 bg-transparent border border-black text-white rounded-full font-Poppins">El9a dawarat</button>
      </div>
    </div>
    </div>
    </div>
